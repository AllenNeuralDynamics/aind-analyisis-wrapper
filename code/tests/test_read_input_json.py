...
class TestReadInputJson(unittest.TestCase):
    ...
    def test_read_input_json_success(self, mock_json_load, mock_open, mock_glob):
        ...
        mock_glob.return_value = [pathlib.Path("/some/directory/file.json")]  # Simulate the path returned by glob
        mock_open.return_value.__enter__.return_value = MagicMock()  # Simulate the open context manager
        mock_json_load.return_value = {"s3_location":"s3://codeocean-s3datasetsbucket-1u41qdg42ur9/7f1eaf10-01bc-41cb-bc88-6464d0425b51/nwb/behavior_769038_2025-02-10_13-16-09.nwb","analysis_spec":{"analysis_name":"Unit_yield","analysis_version":"0.1.0","analysis_libraries_to_track":["aind-ephys-utils"],"analysis_parameters":{"alpha":0.1}}}  # Simulate the JSON content
        
        # Call the function
        result = read_input_json()
        
        # Verify the result
        self.assertEqual(result, {"s3_location":"s3://codeocean-s3datasetsbucket-1u41qdg42ur9/7f1eaf10-01bc-41cb-bc88-6464d0425b51/nwb/behavior_769038_2025-02-10_13-16-09.nwb","analysis_spec":{"analysis_name":"Unit_yield","analysis_version":"0.1.0","analysis_libraries_to_track":["aind-ephys-utils"],"analysis_parameters":{"alpha":0.1}}})
        
        # Verify the interactions
        mock_glob.assert_called_once_with('*.json')
        mock_open.assert_called_once_with(pathlib.Path("/some/directory/file.json"), 'r')
